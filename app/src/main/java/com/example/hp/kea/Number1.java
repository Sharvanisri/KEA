...
public class Number1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = (ImageButton) findViewById(R.id.number1previousbutton);
        button2 = (ImageButton) findViewById(R.id.number1homebutton);
        button3 = (ImageButton) findViewById(R.id.number1nextbutton);
        button4 = (ImageButton) findViewById(R.id.number1videobutton);
