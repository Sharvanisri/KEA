...
public class Number2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = (ImageButton) findViewById(R.id.number2previousbutton);
        button2 = (ImageButton) findViewById(R.id.number2homebutton);
        button3 = (ImageButton) findViewById(R.id.number2nextbutton);
        button4 = (ImageButton) findViewById(R.id.number2videobutton);
